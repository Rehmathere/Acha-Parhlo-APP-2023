  ...
  export default function D1_10Mark() {
    ...
    const submitFiles = async () => {
      try {
        ...
        Keyboard.dismiss();
        navigation.navigate("Z_Test_Part_D2", { documentId: documentId });
      } catch (error) {
        alert(error);
      }
    };
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.firstParent}>
          ...
          <Text style={styles.firPar}>
            Kindly Upload Your 10th Class Marksheet In JPG / PNG Format.
          </Text>
          {/* Image */}
        ...
        <View style={styles.firstParent}>
          ...
          <Text style={styles.firPar}>
            Kindly Upload Your 10th Class Certificate In JPG / PNG Format.
          </Text>
          {/* Image */}
          <View style={styles.ParentImg}>
