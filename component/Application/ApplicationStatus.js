          ...
          <View style={styles.sub_ParentMiniCourseDetail}>
            ...
            <View style={styles.MiniCourseDetail}>
              ...
              <Text style={styles.Item2}>
                {U1_universityName.substring(0, 18)}
              </Text>
        ...
        <View style={styles.Parent_Processing}>
          ...
          <View style={styles.Parent_Processing_Box1}>
            <View style={styles.Parent_Processing_Box1_Part1}>
              ...
              <View
                style={[
                  styles.Parent_Processing_Box1_Part1_Image,
                  { backgroundColor: button1Color },
                ]}
              >
                <Image
                  source={require("../Pics/step1.png")}
                  style={styles.Parent_Processing_Box1_Part1_ImageIcon}
                />
              </View>
              {/* Line Part */}
              <View style={styles.Parent_Processing_Box1_Part1_ParentLine}>
                <Text
                  style={[
                    styles.Parent_Processing_Box1_Part1_Line,
            ...
            <View style={styles.Parent_Processing_Box1_Part2}>
              <Text style={styles.Parent_Processing_Box1_Part2_Text1}>
                Application Received
              </Text>
              <Text style={styles.Parent_Processing_Box1_Part2_Text2}>
                Step 1
              </Text>
            </View>
          </View>
          ...
          <View style={styles.Parent_Processing_Box1}>
            <View style={styles.Parent_Processing_Box1_Part1}>
              ...
              <View
                style={[
                  styles.Parent_Processing_Box1_Part1_Image,
                  { backgroundColor: button8Color, marginBottom: 30 },
                ]}
              >
                <Image
                  source={require("../Pics/step8.png")}
                  style={styles.Parent_Processing_Box1_Part1_ImageIcon}
                />
              </View>
              {/* No Line Part */}
